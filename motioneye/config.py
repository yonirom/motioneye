...
def motion_camera_ui_to_dict(ui, prev_config=None):
    ...
    if ui['mqtt_end_notifications_enabled']:
        on_event_end.append(
            "{script} '{message}' '{url}'".format(
                script=meyectl.find_command('mqtt'),
...
def motion_camera_dict_to_ui(data):
    ...
    for e in on_event_start:
        if ' sendmail ' in e:
            ...
            ui['mqtt_notifications_url'] = e[-2]
            ui['mqtt_notifications_message'] = e[-1]
    ...
    for e in on_event_end:
        if ' webhook ' in e:
            ...
            ui['mqtt_end_notifications_url'] = e[-2]
            ui['mqtt_end_notifications_message'] = e[-1]
